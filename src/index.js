...
function riddleGenerator(event) {
  ...
  let prompt = `display a fun short riddle on the subject only provided by ${userInstructions.value}. Provide the answer to the riddle seperated from the riddle by a <br /><br />. Please display the ridde as follows Riddle: Answer: both in a <strong> element`;
  let context = `you are a playful riddle AI assistant who enjoys giving users a challenging riddle about the subect provided by ${userInstructions.value}`;
